...
<body>
    <div class="container mt-5">
        <div class="card shadow-lg">
            ...
            <a href="{{route("admin.roomsUser.edit",['id'=> $room->id])}}" class="btn btn-secondary" style="background-color: blue;">Sửa thông tin</a>
            <a href="{{ route('home') }}" class="btn btn-secondary" style="background-color: red;">Quay lại</a>
            </div>
        </div>
    </div>
